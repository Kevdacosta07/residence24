  ...
  "@graph": [
    {
      ...
      url: siteUrl,
      name: "Residence24",
      description: "Intendance privée, home sitting et gestion de résidence à Genève.",
      inLanguage: "fr-CH",
    ...
    },
    {
      ...
      description: "Service confidentiel d’intendance privée, home sitting et gestion de résidence pour villas, appartements et résidences secondaires à Genève.",
      inLanguage: "fr-CH",
    ...
    },
    {
      ...
      url: toCdnAsset("/images/hero-villa.jpg"),
      contentUrl: toCdnAsset("/images/hero-villa.jpg"),
      caption: "Villa contemporaine suivie par Residence24 à Genève",
    },
    {
      "@type": "BreadcrumbList",
    ...
    },
    {
      ...
      areaServed: ["Genève", "Cologny", "Collonge-Bellerive", "Vandoeuvres", "Chêne-Bougeries", "Bellevue", "Genthod", "Pregny-Chambésy", "Anières"],
      address: { "@type": "PostalAddress", addressLocality: "Genève", addressCountry: "CH" },
      knowsLanguage: ["fr", "en"],
      knowsAbout: ["intendance privée", "gestion de résidence", "gestion de villa", "home sitting", "house sitting", "coordination de prestataires", "résidence secondaire", "présence domicile"],
      contactPoint: {
        "@type": "ContactPoint",
      ...
      hasOfferCatalog: {
        ...
        itemListElement: services.map((service) => ({
          ...
          itemOffered: {
            ...
            category: "Gestion de résidence à Genève",
